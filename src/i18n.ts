...
const D = {
  ...
  statusRound: { en: 'round {r}', ru: 'раунд {r}' },
  statusCooperative: { en: 'cooperative {c}%', ru: 'сотрудничество {c}%' },
  ...
  gossipHint: { en: 'signal strength per observed action;<br>with 8 flies, 6 observations per round;<br>0: own experience only;<br>1: others’ actions count like your own.', ru: 'сила сигнала за увиденное действие;<br>при 8 мухах 6 наблюдений за раунд;<br>0: только свой опыт;<br>1: чужой, как свой.' },
  ...
  cooperation: { en: 'Cooperation', ru: 'Сотрудничество' },
